...
import com.example.themovieapps.db.DatabaseContract.FavoriteSerial.Companion.TABLE_NAME
...
class SerialHelper(context: Context?) : QueryFavorite {
    ...
    override fun queryAll(): Cursor {
        return database.query(DATABASE_TABLE, null, null, null, null, null, "${DatabaseContract.FavoriteSerial._ID} ASC", null)
    }
    ...
    override fun deleteBy(id: String?): Int {
        return database.delete(DATABASE_TABLE, "${DatabaseContract.FavoriteSerial._ID} = '$id'", null)
    }
}